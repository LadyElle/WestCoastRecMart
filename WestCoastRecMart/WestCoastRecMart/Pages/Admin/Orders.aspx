<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Admin/Admin.Master" 
    AutoEventWireup="true" CodeBehind="Orders.aspx.cs" Inherits="WestCoastRecMart.Pages.Admin.Orders" 
...
<div class="outerContainer">
    <table id="ordersTable">
        ...
        <asp:Repeater runat="server" SelectMethod="GetOrders" ItemType="WestCoastRecMart.Models.Order">
            <ItemTemplate>
                <tr>
                    <td><%#: Item.Name %></td>
                    <td><%#: Item.City %></td>

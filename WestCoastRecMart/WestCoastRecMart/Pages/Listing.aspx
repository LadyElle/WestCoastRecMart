<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listing.aspx.cs" MasterPageFile="/Pages/Store.Master" Inherits="WestCoastRecMart.Pages.Listing" %>
...
<asp:Content ContentPlaceHolderID="bodyContent" runat="server">
    ...
    <div id ="content">
        ...
        <asp:Repeater ItemType="WestCoastRecMart.Models.Product" SelectMethod ="GetProducts" runat="server">
            <ItemTemplate>
                <div class="item">
                    <h3><%# Item.Name %></h3>
                    <%# Item.Description %>
